...
def get_params():
    ...
    parser.add_argument('--train_data_path', type=str,default='TrainData/', help='mnist | cifar10 | mnistm | usps')
    parser.add_argument('--test_data_path', type=str,default='TestData/', help='mnist | cifar10 | mnistm | usps')
    parser.add_argument('--sourceroot', type=str, help='path to source dataset')
    ...
    print('Parsed arguments: ', json.dumps(vars(opt), indent=2))
